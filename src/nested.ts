...
export function getNonEmptyQuestions(questions: Question[]): Question[] {
    return questions.filter(
        (question: Question) =>
            question.body || question.expected || question.options.length,
    );
}
...
export function findQuestion(
    ...
    let found: number | undefined = questions.findIndex(
...
export function sameType(questions: Question[]): boolean {
    return questions.every((question: Question): boolean =>
        question.type === questions[0].type ? true : false,
    );
}
...
export function duplicateQuestionInArray(
    ...
    return questions.reduce(
        (accQuestions: Question[], currQuestion: Question): Question[] =>
            currQuestion.id === targetId ?
                [
                    ...accQuestions,
                    currQuestion,
                    duplicateQuestion(newId, currQuestion),
                ]
